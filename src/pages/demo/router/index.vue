...
function pushByString() {
  // 字符串路径
  router.push('/pages/demo/router/demo-string')
  showSuccess({ msg: '使用字符串路径跳转' })
}

function pushByPath() {
  // 带有路径的对象
  router.push({ path: '/pages/demo/router/demo-object' })
...
function pushWithQuery() {
  ...
  // 带查询参数
  router.push({ path: '/pages/demo/router/demo-query', query: { username: searchKeyword.value } })
...
function pushWithObjectQuery() {
  ...
  // path+query传递对象参数
  router.push({
    path: '/pages/demo/router/demo-query',
...
function demoPushTab() {
  router.pushTab('/pages/demo/router/demo-object')
  showSuccess({ msg: 'router.pushTab() - 跳转到tabBar页面' })
}

function demoReplace() {
  router.replace('/pages/demo/router/demo-object')
  showSuccess({ msg: 'router.replace() - 替换当前页面' })
}

function demoReplaceAll() {
  router.replaceAll('/pages/demo/router/demo-object')
